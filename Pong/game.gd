...
func _process(delta):
  ...
  if (left_pos.y > 40 and Input.is_action_pressed("left_move_up")):
    left_pos.y += -PAD_SPEED * delta

  if (left_pos.y < screen_size.y-40 and Input.is_action_pressed("left_move_down")):
    left_pos.y += PAD_SPEED * delta
  ...
  if (right_pos.y > 40 and Input.is_action_pressed("right_move_up")):
    right_pos.y += -PAD_SPEED * delta

  if (right_pos.y < screen_size.y-40 and Input.is_action_pressed("right_move_down")):
    right_pos.y += PAD_SPEED * delta
